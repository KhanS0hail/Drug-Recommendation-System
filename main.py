...
workout = pd.read_csv("datasets/diseases_workout.csv")
description = pd.read_csv("datasets/description.csv")
medications = pd.read_csv('datasets/medication.csv')
diets = pd.read_csv("datasets/adjusted_diets.csv")
...
# List of valid symptoms derived from symptoms_dict
valid_symptoms = [
    'itching', 
    'skin_rash', 
...
def validate_symptoms(patient_symptoms):
    invalid_symptoms = []
    for symptom in patient_symptoms:
        if symptom not in valid_symptoms:  # Use valid symptoms list for validation
...
def home():
    if request.method == 'POST':
        ...
        if not symptoms:
            ...
            invalid_symptoms = validate_symptoms(user_symptoms)
            if invalid_symptoms:
                invalid_msg = f"Invalid symptoms entered: {', '.join(invalid_symptoms)}"
                message = f"{invalid_msg}. Please correct the spelling or choose valid symptoms."
                return render_template('index.html', message=message)
